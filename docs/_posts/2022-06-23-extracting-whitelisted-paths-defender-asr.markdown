...
categories: security windows windows-11 lsass hvci credguard asr red-team
...
I would recommend the [great research by hfiref0x here](https://github.com/commial/experiments/tree/master/windows-defender/ASR).
